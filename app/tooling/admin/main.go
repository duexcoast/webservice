...
import (
	...
	"github.com/duexcoast/webservice/business/data/schema"
...
func genToken() error {
	...
	// limit PEM file size to 1 MB. This should be reasonable for almost any PEM
	// file and prevents shenanigans like linking the file to /dev/random or
	// something like that.
	...
	// Generating a token requires defining a set of claims. In this application's
	...
	// nbf (not before time): Time before wihch the JWT must not be accepted for processing
