...
// metrics represents the set of metrics we gather. These fields are safe to
// be accessed concurrently thanks to expvar. No extra abstraction is required.
type metrics struct {
...
// inside of expvar is registered as a singleton. The use of once will make sure
...
// key is how metric values are stored/received.
const key ctxKey = 1
...
// Add more of these functions when a metric needs to be collected in different
// parts of the codebase. This will keep this package the central authority for
// metrics and metrics won't get lost.

// AddGoroutines increments the goroutines metric by 1 every 100 requests.
